        ...
        <body>
          <div id="capture-card" class="card">
            ...
            <div class="stamp-container">
              ${localWatermark ? `<img class="stamp-img" src="${localWatermark}" />` : `<span style="font-size: 8px; color: rgba(255,255,255,0.3); font-weight: bold;">بواسطة روح الذكية</span>`}
            </div>
          </div>
        </body>
        </html>
      ...
      container.innerHTML = `
        <div style="padding: 80px 50px; background-color: #0c0d12; color: white; min-height: 1100px;">
          ...
          <div style="margin-top: 100px; text-align: right; font-size: 14px; color: #475569; padding-top: 40px; border-top: 1px solid rgba(255,255,255,0.05); display: flex; flex-direction: column; align-items: flex-end; gap: 8px;">
            ${localBarcodeWatermark ? `<img src="${localBarcodeWatermark}" style="width: 60px; height: 60px; object-fit: contain; margin-bottom: 10px;" />` : `<div style="color: #ec4899; font-weight: 900; font-size: 18px; margin-bottom: 5px;">روح الذكية - Rooh AI</div>`}
